{/* शाळेची माहिती */}
export default function Anganwadi() {  
    return(
<section className="max-w-6xl mx-auto px-4 py-16">
  ...
  <div className="bg-white rounded-3xl shadow-xl p-6">
    ...
    {/* School Image */}
    <div className="overflow-hidden rounded-3xl shadow-2xl group overflow-hidden">
      <img
        src="../Images/Anganwadi.jpg"
        alt="अंगणवाडी"
    ...
    <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
     ...
     <div className="floating bg-gradient-to-br from-blue-50 to-indigo-100 rounded-full w-40 h-40 mx-auto flex flex-col justify-center items-center shadow-xl hover:scale-110 transition-all duration-500"> 
       <div className="float-1 ">👨‍🎓</div>
        ...
        <h4 className="font-bold text-xl">३८ </h4>
      </div>

      <div className="floating bg-gradient-to-br from-blue-50 to-indigo-100 rounded-full w-40 h-40 mx-auto flex flex-col justify-center items-center shadow-xl hover:scale-110 transition-all duration-500"> 
       <div className="float-2 ... ">👦</div>
        <p className="mt-2 text-center">मुले</p>
        <h4 className="font-bold text-xl">२२</h4>
      </div>

      <div className="floating bg-gradient-to-br from-blue-50 to-indigo-100 rounded-full w-40 h-40 mx-auto flex flex-col justify-center items-center shadow-xl hover:scale-110 transition-all duration-500">
       <div className="float-3 ...">👧</div>
        <p className="mt-2 text-center">मुली</p>
        <h4 className="font-bold text-xl">१६</h4>
      </div>
